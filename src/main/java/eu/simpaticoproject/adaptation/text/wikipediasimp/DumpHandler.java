package eu.simpaticoproject.adaptation.text.wikipediasimp;
                        ...
                        for (int i = 0; i < diffs.size(); i++) {
                            ...
                            case EQUAL:
                                if (len < 100) {
                                    ...
                                    if (i != 0) {
                                        after.append(diff.text.substring(0, 40));
                                        before.append(diff.text.substring(0, 40));
                                    }
                                    after.append(" [...] ");
                                    before.append(" [...] ");
                                    if (i != diffs.size() - 1) {
                                        after.append(diff.text.substring(len - 40, len));
                                        before.append(diff.text.substring(len - 40, len));
                                    }
                                }
                                break;
                            case DELETE:
