...
public class LinkingSkipModel {

    private static LinkingSkipModel instance;
    //    private Map<String, String> lemmaList;
    private Map<String, String> replaceList;
    private Set<String> skipList;
    private static final Logger LOGGER = LoggerFactory.getLogger(LinkingSkipModel.class);

    private LinkingSkipModel(String listFile) {
...
//            System.out.println(replaceList);
    ...
    public static LinkingSkipModel getInstance(String listFile) {
        if (instance == null) {
            instance = new LinkingSkipModel(listFile);
        }
